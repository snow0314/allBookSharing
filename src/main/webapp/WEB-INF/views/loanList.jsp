...
<body>
	...
	<nav id="submenu">
		...
		<br>
		<button class="subbtn" onclick="location.href = 'movemypage' ">마이
			페이지</button>
		<br>
		<button class="subbtn"
			onclick="location.href = 'deliveryapplicationmove' ">배송신청목록</button>
		<br>
		<button class="subbtn" onclick="location.href = 'moveloanlist'">대출
			목록</button>
		<br>
		<button class="subbtn" onclick="location.href = 'movehopelist'">희망
			도서 신청 목록</button>
	</nav>
	<main id="totalsearchlist">
		<div>
			<h1
				style="font-family: 'Hanna', sans-serif; margin-bottom: 30px; margin-top: 4%;">대출
				목록</h1>
			<hr />
					...
					<div class="modal-content">
						<div class="modal-header" id="modal-header">
							...
							<span class="star-input"> <span class="input"> <input
									type="radio" name="rv_grade" id="p1" class="point" value="0.5"><label
									for="p1">0.5</label> <input type="radio" name="rv_grade"
									id="p2" class="point" value="1"><label for="p2">1</label>
									<input type="radio" name="rv_grade" id="p3" class="point"
									value="1.5"><label for="p3">1.5</label> <input
									type="radio" name="rv_grade" id="p4" class="point" value="2"><label
									for="p4">2</label> <input type="radio" name="rv_grade" id="p5"
									class="point" value="2.5"><label for="p5">2.5</label> <input
									type="radio" name="rv_grade" id="p6" class="point" value="3"><label
									for="p6">3</label> <input type="radio" name="rv_grade" id="p7"
									class="point" value="3.5"><label for="p7">3.5</label> <input
									type="radio" name="rv_grade" id="p8" class="point" value="4"><label
									for="p8">4</label> <input type="radio" name="rv_grade" id="p9"
									class="point" value="4.5"><label for="p9">4.5</label> <input
									type="radio" name="rv_grade" id="p10" class="point" value="5"><label
									for="p10">5</label>
							</span> <input type="hidden" name="${_csrf.parameterName}"
								value="${_csrf.token}" /> <output for="star-input">
									<b id="score">0</b>점
								</output>
							</span>
						</div>
						...
						<div class="modal-body" id="modal-body">
							<input type="text" name="rv_contents" id="rv_contents"> <input
								type='hidden' name='rv_bcode' id='rv_bcode'>
						</div>
